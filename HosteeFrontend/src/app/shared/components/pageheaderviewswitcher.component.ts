  ...
  template: `
    <div class="bg-slate-100 border border-slate-200/50 rounded-xl p-1 flex items-center gap-1.5 shadow-inner">
            <button 
              ...
              [ngClass]="viewMode() === 'card' ? 'bg-white text-slate-800 shadow-sm' : 'text-slate-400 hover:text-slate-600'">
              <i class="pi pi-th-large"></i> Card
            </button>
            <button 
              ...
              <i class="pi pi-sliders-v"></i> Kanban
            </button>
            <button 
